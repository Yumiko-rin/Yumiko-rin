...
&nbsp;
<img src="https://img.shields.io/badge/%E6%97%B6%E5%8C%BA-UTC%2B8-ffb86c?style=flat-square" alt="时区 UTC+8" />
&nbsp;
...
| | |
|:---:|:---|
| 🔭 **我正在探索** | 计算机科学的世界，把想法变成可以运行的代码 |
| 🌱 **当前专注** | C++ / Python / Web 全栈开发 |
| 💬 **欢迎来聊** | 算法 · 后端架构 · 有趣的开源项目 |
| ⚡ **关于我** | 夜猫子选手，咖啡驱动，debug 使我快乐 |
| 📫 **找到我** | [点击这里给我留言](https://github.com/Yumiko-rin/Yumiko-rin/issues) |
...
[![](https://skillicons.dev/icons?i=c,cpp,py,js,ts&theme=dark)](https://skillicons.dev)

**前端**

[![](https://skillicons.dev/icons?i=html,css,react,vue,tailwind&theme=dark)](https://skillicons.dev)

**后端与数据**

[![](https://skillicons.dev/icons?i=nodejs,express,mysql,redis&theme=dark)](https://skillicons.dev)

**工具链**

[![](https://skillicons.dev/icons?i=git,githubactions,linux,docker,vscode,vite&theme=dark)](https://skillicons.dev)
